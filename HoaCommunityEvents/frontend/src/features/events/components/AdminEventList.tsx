            ...
            <Fragment key={event.id}>
              <div className={`space-y-3 p-4 ${rowTone}`}>
                ...
                <div className="grid grid-cols-1 gap-2">
                  ...
                  >
                    <Edit className="mr-1 h-4 w-4" /> Edit Event
                  </Button>
                  <Button
                    variant="outline"
                    size="sm"
                  ...
                  >
                    <Eye className="mr-1 h-4 w-4" /> View Attendees
                  </Button>
                  {isPending && !isEnded && (
                    <Button
                      variant="outline"
                  ...
                  {!isCancelled && !isEnded && (
                    ...
                    >
                      <XCircle className="mr-1 h-4 w-4" /> Cancel Event
                    </Button>
                  )}
                  <Button
                    variant="outline"
              ...
              {showExpandedPanel && (
                <div className={isDark ? "bg-stone-900/45 p-4" : "bg-stone-50/70 p-4"}>
                  {isEditExpanded
