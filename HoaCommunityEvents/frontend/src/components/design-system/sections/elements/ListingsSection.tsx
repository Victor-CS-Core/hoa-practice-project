...
const ITEMS = [
  {
    ...
    subtitle: "Updated 2h ago · Marie",
    status: "Active",
  },
  {
    id: 2,
    title: "Q2 marketing rollout",
    subtitle: "Updated yesterday · Jordan",
    status: "Active",
  },
  {
    id: 3,
    title: "API v2 migration",
    subtitle: "Updated 3d ago · Priya",
    status: "Draft",
  },
  {
    id: 4,
    title: "Mobile launch checklist",
    subtitle: "Archived last week",
    status: "Archived",
  },
];
    ...
    <SectionShell
      ...
      description={
        <>
          ...
          resource indexes. Each row composes an icon, a title, supporting
          metadata, an optional Badge, a chevron affordance, and (for items in a
          collection) a standard settings dropdown.
        </>
      }
      whenToUse={
        <ul>
      ...
      options={
        <ul className="list-disc pl-5">
          <li>
            Wrap rows in <code>&lt;a&gt;</code> for navigation, or{" "}
            <code>&lt;button&gt;</code> for in-page selection.
          </li>
          <li>Drop the chevron when the row is non-navigable.</li>
          <li>
            Use <code>truncate</code> on title and subtitle to prevent overflow.
          </li>
          <li>
